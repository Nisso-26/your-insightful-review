...
const testimonials = [
  { name: "Julien M.", context: "Paris — acquisition à Tours", text: "HUNTERS m'a trouvé un T3 à Tours avec 7,8% de rendement net en moins de 3 semaines. La gestion de A à Z m'a évité un stress considérable." },
  { name: "Sophie K.", context: "Investisseuse, Lyon", text: "Premier investissement totalement géré par HUNTERS. Travaux, déco, mise en location... Je n'ai eu qu'à valider. Résultat : loué en 6 jours." },
  { name: "Thomas L.", context: "Investisseur, Bordeaux", text: "L'analyse fiscale m'a permis d'économiser plusieurs milliers d'euros. Un niveau d'expertise que je n'avais pas chez mon banquier." },
];
  ...
  return (
    <section id="temoignages" className="bg-background py-24">
      <div className="container mx-auto px-6" ref={ref}>
        <p className="section-tag mb-4" data-reveal>Témoignages</p>
