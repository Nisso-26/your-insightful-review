const steps = [
  {
    ...
    desc: "Analyse de votre situation financière, objectifs de rendement et stratégie fiscale optimale.",
  },
  {
    num: "02",
    title: "Mission de conseil",
    desc: "Signature du mandat de recherche et définition précise des critères de sélection.",
  },
  {
    num: "03",
    title: "Chasse active",
    desc: "Prospection multi-canaux, accès off-market, sélection et visites ciblées pour vous.",
  },
  {
    num: "04",
    title: "Acquisition",
    desc: "Offre d'achat, négociation, accompagnement compromis et signature acte authentique.",
  },
  {
    num: "05",
    title: "Clé en main",
    desc: "Gestion des travaux, décoration, ameublement et mise en location — tout est géré.",
  },
];
...
const ProcessSection = () => (
  <section id="processus" className="bg-primary py-24">
    <div className="container mx-auto px-6">
      <p className="section-tag mb-4">Notre méthode</p>
      <h2 className="font-display text-4xl font-light text-white sm:text-5xl lg:text-[58px] mb-20">
