  ...
  <footer className="bg-foreground py-16">
    <div className="container mx-auto px-6">
      <div className="grid gap-10 md:grid-cols-3">
        ...
        {/* Contact */}
        <div>
          <h4 className="font-body text-[10px] font-bold uppercase tracking-[3px] text-accent mb-4">
            Contact
          </h4>
        ...
        <div>
          ...
          <div className="space-y-2">
            <a href="/mentions-legales" className="block font-body text-sm text-white/50 hover:text-accent transition-colors">
              Mentions légales
            </a>
            <a href="/confidentialite" className="block font-body text-sm text-white/50 hover:text-accent transition-colors">
