...
const BandeauSection = () => {
  ...
  return (
    <div className="bg-accent py-6" ref={ref}>
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-6 text-center sm:flex-row sm:text-left" data-reveal>
