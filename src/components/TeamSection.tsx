...
const team = [
  {
    ...
    zone: "Tours & France entière",
    specialty: "Expert en stratégie patrimoniale et investissement locatif. Plus de 10 ans d'expérience dans l'immobilier.",
    founder: true,
  },
  {
    name: "Marie Laurent",
    role: "Chasseur Immobilier",
    zone: "Tours & Indre-et-Loire",
    specialty: "Spécialisée dans la recherche de biens à fort potentiel locatif en Centre-Val de Loire.",
    founder: false,
  },
  {
    name: "Thomas Bernard",
    ...
    specialty: "Expert du marché bordelais, spécialisé immeubles de rapport et colocation.",
    founder: false,
  },
];
...
const TeamSection = () => (
  <section id="equipe" className="bg-background py-24">
    <div className="container mx-auto px-6">
      <p className="section-tag mb-4">L'équipe</p>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {team.map((member) => (
          ...
          >
            ...
            {/* Photo placeholder */}
            <div
              className={`relative bg-primary/10 ${member.founder ? "h-[380px]" : "h-[320px]"}`}
            >
        ...
        {/* CTA Card - Rejoindre */}
        <div className="flex flex-col items-center justify-center rounded-lg bg-primary p-8 text-center sm:col-span-2 lg:col-span-3">
